...
# Web Scraping from "https://www.kobo.com"
✅ I scraped the info from this website.

✅ I scraped this webpage using project-appropriate libraries.

✅ Alternative techniques, such as selenium and pupeeter, can also be tried.

✅ Data was scraped from many fields, including name, author, and price.

✅ The function runs asynchronously using playwright for quicker performance.

✅ Playwright assisted in rendering the website's content because to its extensive use of JavaScript.
